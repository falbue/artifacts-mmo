...
if TYPE_CHECKING:
  from ..models.ge_order_history_schema import GeOrderHistorySchema





T = TypeVar("T", bound="DataPageGeOrderHistorySchema")
...
class DataPageGeOrderHistorySchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = GeOrderHistorySchema.from_dict(data_item_data)
        ...
        data_page_ge_order_history_schema = cls(
            data=data,
            total=total,
            page=page,
            size=size,
        ...
        data_page_ge_order_history_schema.additional_properties = d
        return data_page_ge_order_history_schema
