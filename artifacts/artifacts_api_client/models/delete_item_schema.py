...
T = TypeVar("T", bound="DeleteItemSchema")
...
class DeleteItemSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        item = SimpleItemSchema.from_dict(d.pop("item"))
        ...
        delete_item_schema.additional_properties = d
        return delete_item_schema
