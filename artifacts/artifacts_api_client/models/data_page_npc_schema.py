...
T = TypeVar("T", bound="DataPageNPCSchema")
...
class DataPageNPCSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = NPCSchema.from_dict(data_item_data)
        ...
        data_page_npc_schema.additional_properties = d
        return data_page_npc_schema
