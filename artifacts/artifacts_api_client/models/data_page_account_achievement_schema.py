...
if TYPE_CHECKING:
  from ..models.account_achievement_schema import AccountAchievementSchema





T = TypeVar("T", bound="DataPageAccountAchievementSchema")
...
class DataPageAccountAchievementSchema:
    """ 
        Attributes:
            data (list['AccountAchievementSchema']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = AccountAchievementSchema.from_dict(data_item_data)
        ...
        data_page_account_achievement_schema = cls(
            data=data,
            total=total,
            page=page,
            size=size,
        ...
        data_page_account_achievement_schema.additional_properties = d
        return data_page_account_achievement_schema
