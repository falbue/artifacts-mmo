...
if TYPE_CHECKING:
  ...
  from ..models.ge_order_created_schema import GEOrderCreatedSchema
...
T = TypeVar("T", bound="GEOrderTransactionSchema")
...
class GEOrderTransactionSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        order = GEOrderCreatedSchema.from_dict(d.pop("order"))
        ...
        ge_order_transaction_schema = cls(
            cooldown=cooldown,
            order=order,
            character=character,
        )
        ...
        ge_order_transaction_schema.additional_properties = d
        return ge_order_transaction_schema
