...
T = TypeVar("T", bound="DataPageResourceSchema")
...
class DataPageResourceSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = ResourceSchema.from_dict(data_item_data)
        ...
        data_page_resource_schema.additional_properties = d
        return data_page_resource_schema
