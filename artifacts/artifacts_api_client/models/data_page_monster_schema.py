...
if TYPE_CHECKING:
  from ..models.monster_schema import MonsterSchema





T = TypeVar("T", bound="DataPageMonsterSchema")
...
class DataPageMonsterSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = MonsterSchema.from_dict(data_item_data)
        ...
        data_page_monster_schema.additional_properties = d
        return data_page_monster_schema
