...
T = TypeVar("T", bound="CharacterMovementDataSchema")
...
class CharacterMovementDataSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        destination = MapSchema.from_dict(d.pop("destination"))
        ...
        character_movement_data_schema = cls(
            cooldown=cooldown,
            destination=destination,
            character=character,
        )
        ...
        character_movement_data_schema.additional_properties = d
        return character_movement_data_schema
