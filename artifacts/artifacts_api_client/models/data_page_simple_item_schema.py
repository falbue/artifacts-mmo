...
T = TypeVar("T", bound="DataPageSimpleItemSchema")
...
class DataPageSimpleItemSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = SimpleItemSchema.from_dict(data_item_data)
        ...
        data_page_simple_item_schema = cls(
            data=data,
            total=total,
            page=page,
            size=size,
        ...
        data_page_simple_item_schema.additional_properties = d
        return data_page_simple_item_schema
