...
if TYPE_CHECKING:
  from ..models.active_event_schema import ActiveEventSchema





T = TypeVar("T", bound="DataPageActiveEventSchema")
...
class DataPageActiveEventSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = ActiveEventSchema.from_dict(data_item_data)
        ...
        data_page_active_event_schema = cls(
            data=data,
            total=total,
            page=page,
            size=size,
        ...
        data_page_active_event_schema.additional_properties = d
        return data_page_active_event_schema
