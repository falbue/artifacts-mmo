...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[DataPageGeOrderHistorySchema]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[DataPageGeOrderHistorySchema]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        id (Union[Unset, str]): Order ID to search in your history.
        code (Union[Unset, str]): Item to search in your history.
...
) -> Optional[DataPageGeOrderHistorySchema]:
    """ Get Ge Sell History
