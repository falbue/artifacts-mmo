...
from ...models.equip_schema import EquipSchema
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/my/{name}/action/equip".format(name=name,),
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, EquipmentResponseSchema]]:
    ...
    if response.status_code == 484:
        response_484 = cast(Any, None)
        return response_484

    if response.status_code == 485:
        response_485 = cast(Any, None)
        return response_485
