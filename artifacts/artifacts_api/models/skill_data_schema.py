...
if TYPE_CHECKING:
  ...
  from ..models.skill_info_schema import SkillInfoSchema





T = TypeVar("T", bound="SkillDataSchema")
...
class SkillDataSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        details = SkillInfoSchema.from_dict(d.pop("details"))
        ...
        skill_data_schema.additional_properties = d
        return skill_data_schema
