...
if TYPE_CHECKING:
  from ..models.account_leaderboard_schema import AccountLeaderboardSchema





T = TypeVar("T", bound="DataPageAccountLeaderboardSchema")



@_attrs_define
class DataPageAccountLeaderboardSchema:
    """ 
        Attributes:
            data (list['AccountLeaderboardSchema']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = AccountLeaderboardSchema.from_dict(data_item_data)
        ...
        data_page_account_leaderboard_schema = cls(
            data=data,
            total=total,
            page=page,
            size=size,
        ...
        data_page_account_leaderboard_schema.additional_properties = d
        return data_page_account_leaderboard_schema
