...
T = TypeVar("T", bound="CharacterRestDataSchema")
...
class CharacterRestDataSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        character_rest_data_schema = cls(
            cooldown=cooldown,
            hp_restored=hp_restored,
            character=character,
        )
        ...
        character_rest_data_schema.additional_properties = d
        return character_rest_data_schema
