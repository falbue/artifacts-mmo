...
T = TypeVar("T", bound="DataPageDropRateSchema")



@_attrs_define
class DataPageDropRateSchema:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = DropRateSchema.from_dict(data_item_data)
        ...
        data_page_drop_rate_schema = cls(
            data=data,
            total=total,
            page=page,
            size=size,
        ...
        data_page_drop_rate_schema.additional_properties = d
        return data_page_drop_rate_schema
