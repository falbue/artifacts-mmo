...
T = TypeVar("T", bound="DataPageItemSchema")
...
class DataPageItemSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = ItemSchema.from_dict(data_item_data)
        ...
        data_page_item_schema.additional_properties = d
        return data_page_item_schema
