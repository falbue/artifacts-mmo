...
if TYPE_CHECKING:
  from ..models.npc_item import NPCItem





T = TypeVar("T", bound="DataPageNPCItem")
...
class DataPageNPCItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = NPCItem.from_dict(data_item_data)
        ...
        data_page_npc_item.additional_properties = d
        return data_page_npc_item
