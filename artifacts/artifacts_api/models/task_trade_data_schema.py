...
if TYPE_CHECKING:
  ...
  from ..models.task_trade_schema import TaskTradeSchema





T = TypeVar("T", bound="TaskTradeDataSchema")
...
class TaskTradeDataSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trade = TaskTradeSchema.from_dict(d.pop("trade"))
        ...
        task_trade_data_schema.additional_properties = d
        return task_trade_data_schema
