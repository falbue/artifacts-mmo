...
if TYPE_CHECKING:
  from ..models.effect_schema import EffectSchema





T = TypeVar("T", bound="DataPageEffectSchema")
...
class DataPageEffectSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = EffectSchema.from_dict(data_item_data)
        ...
        data_page_effect_schema.additional_properties = d
        return data_page_effect_schema
