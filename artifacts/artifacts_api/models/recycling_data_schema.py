...
if TYPE_CHECKING:
  ...
  from ..models.recycling_items_schema import RecyclingItemsSchema
...
T = TypeVar("T", bound="RecyclingDataSchema")
...
class RecyclingDataSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        details = RecyclingItemsSchema.from_dict(d.pop("details"))
        ...
        recycling_data_schema.additional_properties = d
        return recycling_data_schema
