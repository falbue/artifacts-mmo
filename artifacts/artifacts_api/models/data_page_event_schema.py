...
T = TypeVar("T", bound="DataPageEventSchema")



@_attrs_define
class DataPageEventSchema:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = EventSchema.from_dict(data_item_data)
        ...
        data_page_event_schema.additional_properties = d
        return data_page_event_schema
