...
if TYPE_CHECKING:
  from ..models.task_full_schema import TaskFullSchema





T = TypeVar("T", bound="DataPageTaskFullSchema")
...
class DataPageTaskFullSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = TaskFullSchema.from_dict(data_item_data)
        ...
        data_page_task_full_schema = cls(
            data=data,
            total=total,
            page=page,
            size=size,
        ...
        data_page_task_full_schema.additional_properties = d
        return data_page_task_full_schema
