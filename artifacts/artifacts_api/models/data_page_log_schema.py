...
T = TypeVar("T", bound="DataPageLogSchema")



@_attrs_define
class DataPageLogSchema:
    """ 
        Attributes:
            data (list['LogSchema']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = LogSchema.from_dict(data_item_data)
        ...
        data_page_log_schema.additional_properties = d
        return data_page_log_schema
