...
if TYPE_CHECKING:
  from ..models.ge_order_schema import GEOrderSchema





T = TypeVar("T", bound="DataPageGEOrderSchema")
...
class DataPageGEOrderSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = GEOrderSchema.from_dict(data_item_data)
        ...
        data_page_ge_order_schema.additional_properties = d
        return data_page_ge_order_schema
