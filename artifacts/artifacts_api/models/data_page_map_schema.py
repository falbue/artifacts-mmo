...
T = TypeVar("T", bound="DataPageMapSchema")
...
class DataPageMapSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = MapSchema.from_dict(data_item_data)
        ...
        data_page_map_schema.additional_properties = d
        return data_page_map_schema
