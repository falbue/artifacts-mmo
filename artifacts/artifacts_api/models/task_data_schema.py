...
T = TypeVar("T", bound="TaskDataSchema")
...
class TaskDataSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task = TaskSchema.from_dict(d.pop("task"))
        ...
        task_data_schema.additional_properties = d
        return task_data_schema
